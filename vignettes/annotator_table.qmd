...
representative set of developmental milestone rows. Check **Met?** to mark a
milestone as achieved, and add a short note — the annotation panel at the
bottom updates in real time to show only rows you have touched.
